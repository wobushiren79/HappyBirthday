...
pointLight(normalize(aNormal),ambientTemp,diffuseTemp,specularTemp,uLightLocationSun,vec4(0.15,0.15,0.15,1.0),vec4(0.988, 0.639, 0.482,1.0),vec4(0.4,0.4,0.4,1.0));
